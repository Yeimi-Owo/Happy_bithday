...
// Función para iniciar el confetti y mostrar el mensaje flotante
function startConfettiAndMessage() {
  // Configuración del confetti y animación
  confetti.render();

  // Mostrar el mensaje flotante después de 10 segundos
  setTimeout(showFloatingMessage, 15000); // 10000 milisegundos = 10 segundos
}
...
function closeFloatingMessage() {
  ...
  // Reaparecer el mensaje después de 15 segundos
  setTimeout(showFloatingMessage, 15000); // 15000 milisegundos = 15 segundos
}

// Asignar el evento click al botón de cerrar
document.getElementById('close-button').addEventListener('click', closeFloatingMessage);
...
//SEGUNDOS - Acesso rapido Math.
  ...
  if (distance > 0) {
    ...
    function showfireworks() {
      ...
      startConfettiAndMessage(); // Inicia el confetti y muestra el mensaje
    }
